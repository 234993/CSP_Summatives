...
def get_names(file_name):
    ...
    for line in leaderboard_file:
        ...
        names.append(leader_name.strip())
    #print(names)
...
def get_scores(file_name):
  ...
  for line in leaderboard_file:
    ...
    while (line[index]!= ","):
       index += 1 
    index += 1 #added one to move past the comma 
    #print(index)-just to verify that it works, dont need  
    # TODO 4: use a while loop to get the score
    while index < len(line) and line[index] != "\n":
       leader_score = leader_score + line[index]
       index += 1 
    #print(leader_score)-just to verify that it works, dont neeed 
